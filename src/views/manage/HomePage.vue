      ...
      <el-row class="h-80px">
        <el-col :span="18" :xs="24">
          <div class="flex-x-start">
            <img class="w80px h80px rounded-full" style="width: 40px;height: 40px;" src="../../assets/1.jpg" />
            <div class="ml-5">
              <p>{{ greetings }}</p>
        ...
        <el-card>
          <template #header>
            <div class="flex-x-between">
              ...
              <el-link type="primary" :underline="false" href="https://gitee.com/youlaiorg/vue3-element-admin/releases"
                target="_blank">
                完整记录

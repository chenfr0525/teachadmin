...
function handleQuery() {
  // loading.value = true;
  // NoticeAPI.getPage(queryParams.value)
  //   .then((data) => {
...
function handleOpenDialog(id) {
  ...
  //   });
  // } else {
  //   Object.assign(formData.value, { level: 0, targetType: 0 });
...
function handleSubmit() {
  ...
  //     if (id) {
  //       NoticeAPI.update(id, formData.value)
  //         .then(() => {
